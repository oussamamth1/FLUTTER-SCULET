...
// class ConversationListGU extends StatefulWidget {
//   String? conversationId; // Add this parameter

//   // Update constructor to accept the new parameter
//   ConversationListGU({Key? key, this.conversationId}) : super(key: key);
//   @override
//   _ConversationListGUState createState() => _ConversationListGUState();
// }

// class _ConversationListGUState extends State<ConversationListGU>
//     with RouteAware {
...
//     Provider.of<ScreenListenerProvider>(context, listen: false)
//         .setOnScreen(false);
//     fetchConversations(_limit).then((fetchedConversations) {
...
//     fetchConversations(_limit).then(
//       (value) {
//         FirebaseMessaging.instance.subscribeToTopic('Topic-Message');
//       },
...
//   void _onConversation(dynamic data) async {
//     if (!mounted) return;
...
//           }
//         }
//         if (isOnScreen && conversationid == conversationId) {
//           if (conversationId != null && conversationId.isNotEmpty) {
//             final conversation = Conversation(
//               id: conversationId,
//               clientUserId: data['clientUserId'],
...
//               latestMessage: latestMessage,
//               latestMessageId: latestMessage.id,
//               guideLastReadMessageId: latestMessage.id,
//             );
...
//         if (updatedConversation.clientLastReadMessageId != null) {
//           existingConversation.clientLastReadMessageId =
//               updatedConversation.clientLastReadMessageId;
//           existingConversation.latestMessage!.id =
//               updatedConversation.latestMessageId;
//           if (isOnScreen && conversationid == existingConversation.id) {
//             existingConversation.guideLastReadMessageId =
//                 updatedConversation.latestMessage?.id;
//           }
//         }
...
//   Future<List<Conversation>> fetchConversations(int? _limit) async {
//     if (mounted) {
//       setState(() {
//         loading = true;
//       });
...
//     try {
//       String? token = await storage.read(key: "access_token");
//       String url = "$baseUrls/api/conversation/me?limit=$_limit";
...
//         if (mounted) {
//           setState(() {
//             // Append more conversations for "load more"
...
//   Future<List<Conversation>> fetchConversationslimit(int? _limit) async {
//     if (mounted) {}
...
//     try {
//       final conversationload = await fetchConversationslimit(_limit);
//       setState(() {
//         // Remove duplicates based on message ID
//         final existingIds = conversations.map((m) => m.id).toSet();
//         final filtered =
//             conversationload.where((m) => !existingIds.contains(m.id)).toList();

//         // Insert at the top
//         conversations.insertAll(0, filtered);
//       });
//       WidgetsBinding.instance.addPostFrameCallback((_) {
//         //  _scrollController.jumpTo(100); // tweak for smoother UX
//       });
//     } catch (e) {
//     } finally {
...
//     // final Guidprovider = await Provider.of<guidProvider>(context, listen: false)
//     //     .loadDataGuidDetail();
//     final url =
...
//             : RefreshIndicator(
//                 onRefresh: () async {
//                   await fetchConversations(_limit); // Call your API function
//                 },
//                 child: uniqueConversations.isEmpty
//                     ? RefreshIndicator(
//                         onRefresh: () async {
//                           await fetchConversations(
//                               _limit); // Call your API function
//                         },
//                         child: Center(
...
//                           if (connction)
//                             Flexible(
//                                 flex: 1, fit: FlexFit.loose, child: Gap(4)),
//                           Flexible(
//                             flex: 25,
//                             fit: FlexFit.loose,
//                             child:
